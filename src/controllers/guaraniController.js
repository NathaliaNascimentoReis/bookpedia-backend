...
export const criar = async (req, res) => {
    try {
        ...
        const item = new GuaraniModel(req.body);
...
export const buscarPorId = async (req, res) => {
    try {
        ...
        const item = await GuaraniModel.buscarPorId(parseInt(id));
...
export const atualizar = async (req, res) => {
    try {
        ...
        if (req.body.estado !== undefined) item.estado = req.body.estado;
        if (req.body.preco !== undefined && req.body.preco !== null)
            item.preco = parseFloat(req.body.preco);
